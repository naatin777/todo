...
class $ProjectsTable extends Projects
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<ProjectTable> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class ProjectTable extends DataClass implements Insertable<ProjectTable> {
  ...
  ProjectTable copyWith({String? id, String? name}) =>
      ProjectTable(id: id ?? this.id, name: name ?? this.name);
...
class $LabelsTable extends Labels with TableInfo<$LabelsTable, LabelTable> {
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<LabelTable> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class LabelTable extends DataClass implements Insertable<LabelTable> {
  ...
  LabelTable copyWith({String? id, String? name}) =>
      LabelTable(id: id ?? this.id, name: name ?? this.name);
...
class $FiltersTable extends Filters with TableInfo<$FiltersTable, FilterTable> {
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<FilterTable> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class FilterTable extends DataClass implements Insertable<FilterTable> {
  ...
  FiltersCompanion toCompanion(bool nullToAbsent) {
    return FiltersCompanion(id: Value(id), name: Value(name));
  }

  factory FilterTable.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  FilterTable copyWith({String? id, String? name}) =>
      FilterTable(id: id ?? this.id, name: name ?? this.name);
...
class $$ProjectsTableTableManager
    extends
        RootTableManager<
          ...
          (
            ProjectTable,
            BaseReferences<_$AppDatabase, $ProjectsTable, ProjectTable>,
          ),
          ProjectTable,
          PrefetchHooks Function()
        > {
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> rowid = const Value.absent(),
              }) => ProjectsCompanion(id: id, name: name, rowid: rowid),
          createCompanionCallback:
              ({
                required String id,
                required String name,
                Value<int> rowid = const Value.absent(),
              }) => ProjectsCompanion.insert(id: id, name: name, rowid: rowid),
          withReferenceMapper:
              (p0) =>
                  p0
                      .map(
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> name = const Value.absent(),
                Value<int> rowid = const Value.absent(),
              }) => LabelsCompanion(id: id, name: name, rowid: rowid),
          createCompanionCallback:
              ({
                required String id,
                required String name,
                Value<int> rowid = const Value.absent(),
              }) => LabelsCompanion.insert(id: id, name: name, rowid: rowid),
          withReferenceMapper:
              (p0) =>
                  p0
                      .map(
...
class $$FiltersTableTableManager
    extends
        RootTableManager<
          ...
          (
            FilterTable,
            BaseReferences<_$AppDatabase, $FiltersTable, FilterTable>,
          ),
          FilterTable,
          PrefetchHooks Function()
        > {
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> name = const Value.absent(),
                Value<int> rowid = const Value.absent(),
              }) => FiltersCompanion(id: id, name: name, rowid: rowid),
          createCompanionCallback:
              ({
                required String id,
                required String name,
                Value<int> rowid = const Value.absent(),
              }) => FiltersCompanion.insert(id: id, name: name, rowid: rowid),
          withReferenceMapper:
              (p0) =>
                  p0
                      .map(
