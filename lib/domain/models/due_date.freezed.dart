...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DueDate&&(identical(other.dateTime, dateTime) || other.dateTime == dateTime)&&(identical(other.isAllDay, isAllDay) || other.isAllDay == isAllDay));
}
...
/// Create a copy of DueDate
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dateTime = freezed,Object? isAllDay = null,}) {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DueDate&&(identical(other.dateTime, dateTime) || other.dateTime == dateTime)&&(identical(other.isAllDay, isAllDay) || other.isAllDay == isAllDay));
}
...
/// Create a copy of DueDate
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dateTime = freezed,Object? isAllDay = null,}) {
